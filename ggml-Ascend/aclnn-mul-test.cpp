...
void aclnn_mul_func_test(int64_t* ne1, int64_t* ne2, float* data1, float* data2, int32_t deviceId, aclrtStream stream){
    ...
    ret = aclnn_mul_func(selfDeviceAddr, otherDeviceAddr, outDeviceAddr, selfShape, otherShape, outShape, aclDataType::ACL_FLOAT, aclDataType::ACL_FLOAT, aclDataType::ACL_FLOAT, stream);
